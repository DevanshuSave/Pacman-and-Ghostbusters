            ...
            if states[i] != "TERMINAL_STATE":
                ...
                for a in potentialActions:
                    ...
                    for j in range(0, len(transitions)):
                        #if states[i] == (0, 1) and iter < 10:
                        #print "ACTION #", j, " == ", transitions[j][1], " * ( ", mdp.getReward(states[i], a, transitions[j][0]), " + ( ", self.discount, " * ", self.values[transitions[j][0]], " ) "
                ...
                #print "State = ", states[i]
                #print "New Value = ", newValues[states[i]]
